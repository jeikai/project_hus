...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th10 27, 2022 lúc 06:02 AM
...
INSERT INTO `diemdanh` (`diemDanhId`, `status`, `studentId`, `classId`, `DAY`) VALUES
(54, 1, 1, 1, '2022-10-26 22:05:40'),
(55, 1, 4, 1, '2022-10-26 22:05:40'),
(56, 1, 1, 1, '2022-10-26 22:06:20'),
(57, 0, 4, 1, '2022-10-26 22:06:20'),
(58, 1, 1, 1, '2022-10-26 22:06:27'),
(59, 1, 4, 1, '2022-10-26 22:06:27'),
(60, 0, 1, 1, '2022-10-26 22:06:37'),
(61, 0, 4, 1, '2022-10-26 22:06:37'),
(62, 1, 1, 1, '2022-10-26 22:58:50'),
(63, 1, 4, 1, '2022-10-26 22:58:50'),
(64, 1, 1, 1, '2022-10-26 23:01:43'),
(65, 0, 4, 1, '2022-10-26 23:01:43'),
(66, 0, 1, 1, '2022-10-26 23:01:56'),
(67, 0, 4, 1, '2022-10-26 23:01:56'),
(68, 1, 1, 1, '2022-10-26 23:02:01'),
(69, 0, 4, 1, '2022-10-26 23:02:01');
...
INSERT INTO `results` (`resultId`, `studentId`, `classId`, `status`, `averageMark`, `componentMark`, `midMark`, `finalMark`) VALUES
(1, 1, 1, b'0', 0, 0, 0, 0),
(2, 4, 1, b'0', 0, 0, 0, 0),
(3, 3, 2, b'0', 0, 0, 0, 0),
(4, 6, 2, b'0', 0, 0, 0, 0),
...
ALTER TABLE `diemdanh`
  ...
  ADD KEY `fk_studentId_diemDanh` (`studentId`),
  ADD KEY `fk_classtId_diemDanh` (`classId`);
...
--
ALTER TABLE `diemdanh`
  MODIFY `diemDanhId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=70;
...
--
ALTER TABLE `timetable`
  MODIFY `timetableId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=25;
...
--
ALTER TABLE `diemdanh`
  ADD CONSTRAINT `fk_classtId_diemDanh` FOREIGN KEY (`classId`) REFERENCES `classes` (`classId`),
  ADD CONSTRAINT `fk_studentId_diemDanh` FOREIGN KEY (`studentId`) REFERENCES `students` (`studentId`);
