...
class AddStudentToClass extends React.Component {
    ...
    handleSubmit = async (event) =>{
        ...
        let response =  await axios.post(`https://test.modnro.xyz/database/data/handleDetailClasses.php/${classId}/student`, emails, {
            headers: {
                ...
                <div className="modal-dialog">
                    ...
                    <div className="modal-body">
                        <form onSubmit={(e)=>{this.handleSubmit(e)}} >
                            <div className="mb-4">
                            <label htmlFor="" className="mb-2" >Student Email: </label>
